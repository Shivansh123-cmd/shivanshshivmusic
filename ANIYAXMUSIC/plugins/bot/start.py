...
async def start_pm(client, message: Message, _):
    ...
    try:
        stk = await message.reply_sticker("CAACAgIAAxkBAAEC6dtpxLSRIlKO1gdqhAcT_eAYf_-AjAACfJcAAiP5KUoqhriQA1WzQzoE")
    ...
    await asyncio.sleep(0.1)
    await loading_1.edit_text("<emoji id='5413840936994097463'>🌺</emoji> <b>˹𝐒ʜɪᴠ ꭙ 𝐌ᴜꜱɪᴄ ♪˼\nsᴛᴧʀᴛed!</b>")
    await asyncio.sleep(0.1)
